...
print("==================================================================")
print("🔍 FORCED MATH VERIFICATION (IGNORING STRICT ENTRY RULES)")
print("==================================================================")
...
for file in all_files:
    ...
    try:
        ...
        print(f"      Upper (Wick): ${z1_upper:.2f}")
        print(f"      Lower (Body): ${z1_lower:.2f}")
        print(f"      Z1 Stop-Loss: ${z1_sl:.2f}    (-1 ATR from Lower)")
        print(f"   ► ZONE 2 (Deep Dip / -5%):")
        print(f"      Upper:        ${z2_upper:.2f}")
        print(f"      Lower:        ${z2_lower:.2f}")
        print(f"      Z2 Stop-Loss: ${z2_sl:.2f}    (-1 ATR from Lower)")
        print("-" * 65)
        count += 1
